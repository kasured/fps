...
abstract class TweetSet {
  ...
  def moreRetweeted(that: Tweet): Tweet
...
class Empty extends TweetSet {
  ...
  override def moreRetweeted(that: Tweet): Tweet = that
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  override def mostRetweeted: Tweet = this moreRetweeted elem

  override def moreRetweeted(that: Tweet): Tweet = {
    val leftMost = left moreRetweeted that
    val rightMost = right moreRetweeted that
